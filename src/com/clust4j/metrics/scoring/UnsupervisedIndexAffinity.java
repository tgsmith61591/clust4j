 ...
 */
public class UnsupervisedIndexAffinity implements SupervisedEvaluationMetric {
	private static final long serialVersionUID = 2913308992441278864L;
	
	private final static UnsupervisedIndexAffinity instance = new UnsupervisedIndexAffinity();
	private UnsupervisedIndexAffinity(){}
	
	public static UnsupervisedIndexAffinity getInstance() {
		return instance;
	}
